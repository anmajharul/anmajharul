...
| **Machine Learning** | XGBoost, PyTorch, Scikit-learn, Optuna (Bayesian HPO) |
| **Deep Learning** | TCN-TFT (Temporal Fusion Transformer), MLP, Variable Selection Networks |
| **Programming** | Python, R, C++, MATLAB |
| **Data Science** | Pandas, NumPy, SPSS, Matplotlib |
| **MLOps & Cloud** | Google Cloud Run, Cloud Scheduler, Supabase, GitHub Actions |
| **APIs** | Mapbox Directions, WeatherAPI, OpenWeatherMap, Google Air Quality |
